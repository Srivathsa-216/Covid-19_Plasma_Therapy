...
<!-- /Added by HTTrack -->
<head>
<title>Sign Up Form Blood Bank</title>
<!-- Meta tag Keywords -->
...
<link href='http://fonts.googleapis.com/css?family=Raleway+Dots'
	rel='stylesheet' type='text/css'>
</head>
...
<body>
	<link rel="stylesheet" href="css/demobar_w3_4thDec2019.css">
	...
	<%
		...
		"insert into blood_bank (Name, Phone_no, Address, Email, Username, Password) values('%s', '%s','%s', '%s', '%s', '%s')",
	...
	<script type="text/JavaScript">
		...
		window.location.href = "../login1/login1.jsp";
	...
	%>
	<script type="text/JavaScript">
		alert("There seems to be an issue, try again! Donor may already exist..");
		window.location.href = "../signup1/signup1.jsp";
	</script>
	<%
		}
		...
		<div class="sub-main">
			...
			<form method="post">
				...
				<input placeholder="Username" name="username" type="text"
					required="" id="username"> <span class="icon5"><i
					class="fa fa-user" aria-hidden="true"></i></span><br> 
				
				<input
					placeholder="Password" name="password" type="password" required="" id="password">
				<span class="icon6"><i class="fa fa-unlock"
				...
				<button type="submit" name="submit_btn" onclick="return validate();">Sign
					UP</button>
